...
public:
    ...
    {
        // The current Mesh implementation generates a procedural terrain
        // and does not load from a file path. Use fixed generation parameters.
        Mesh mesh (80, 80, 4, 0.05f, 1.0f);
