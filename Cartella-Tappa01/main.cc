...
int main() {
    ...
    sf::Window window(
        ...
        "Generatore Procedurale - Tappa 01",
        sf::Style::Default,
        sf::State::Windowed,
        settings
    );
    ...
    while (running) {
        while (const std::optional event = window.pollEvent()) {
            ...
            if (const auto* key_pressed = event->getIf<sf::Event::KeyPressed> ()) handle (*key_pressed, shaders);
        ...
        ImGui::Text("Tappa 01: Griglia Piatta completata.");
