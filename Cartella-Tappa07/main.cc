...
int main() {
    ...
    sf::Window window(
        ...
        "Generatore Procedurale - Tappa 07",
        sf::Style::Default,
        sf::State::Windowed,
        settings
    );
    ...
    while (running) {
        ...
        ImGui::Separator();
        // --- SEZIONE 2: BIOMI (COLORAZIONE PER ALTEZZA) ---
        ImGui::TextColored(ImVec4(0.2f, 0.8f, 0.8f, 1.0f), "SOGLIE BIOMI");
